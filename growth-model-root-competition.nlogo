...
globals [ xid yid mean-yield-sum mutated-plant-yield-sum randomA ]
...
;  ]
  ...
  [
    file-print "Mean Yield, Mutated Yield, Avg. Root Radius, Avg. Shoot Radius, Global A, Mutated Plant A"
  ]
  [
    file-print "Mean Yield, Avg. Root Radius, Avg. Shoot Radius, Global A"
  ]
...
to print-generation-info
  ...
  [    
    ...
    file-type ", "
    file-type precision mean [Rr] of plants 1
    file-type ", "
    file-type precision mean [Rs] of plants 1
    file-type ", "
    file-type A
    file-type ", "
    file-print randomA
  ...
  [
    let average-yield mean [yield] of plants
...
to check-if-apply-mutation
  ...
  if mutated-plant-yield > average-yield
  [
    set A randomA
  ]
  ;; otherwise disgard this mutation
